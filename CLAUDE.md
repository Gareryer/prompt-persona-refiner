...
- **Languages:** javascript (primary), contract, css, gitignore, html, image, js, json, markdown, mcp_config, sql
- **Most-referenced symbols:** `log` (283 usages), `querySelector` (217 usages), `addEventListener` (189 usages), `getElementById` (182 usages), `add` (122 usages), `spLog` (112 usages), `appendChild` (107 usages), `createElement` (102 usages), `forEach` (90 usages), `includes` (80 usages)
- **Graph size:** 2214 nodes, 8294 edges
- **Breakdown:** 71 builtins, 4 contracts, 277 docs, 78 files, 438 functions, 1 images, 231 methods, 181 modules, 2 resources, 6 todos, 478 types, 447 variables
