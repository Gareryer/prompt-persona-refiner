...
- **Languages:** javascript (primary), , contract, css, gitignore, html, image, js, json, markdown, mcp_config, sql, ts, typescript
- **Most-referenced symbols:** `log` (282 usages), `querySelector` (217 usages), `addEventListener` (187 usages), `getElementById` (186 usages), `add` (124 usages), `spLog` (115 usages), `appendChild` (102 usages), `createElement` (97 usages), `forEach` (90 usages), `includes` (81 usages)
- **Graph size:** 2540 nodes, 8788 edges
- **Breakdown:** 91 builtins, 14 contracts, 347 docs, 99 files, 448 functions, 1 images, 1 imports, 3 interfaces, 32 locals, 245 methods, 181 modules, 27 params, 4 resources, 1 strings, 7 todos, 477 types, 562 variables
