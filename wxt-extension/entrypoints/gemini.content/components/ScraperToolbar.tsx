...
export const ScraperToolbar: React.FC<ScraperToolbarProps> = ({
  ...
  const handleExportClick = async (e: React.MouseEvent) => {
    ...
    try {
      ...
      console.warn('[Allie Gemini Toolbar] Export error:', err);
    } finally {
  ...
  const handleSyncClick = async (e: React.MouseEvent) => {
    ...
    try {
      ...
      console.warn('[Allie Gemini Toolbar] Sync error:', err);
    } finally {
      setIsSyncing(false);
    }
  };
  ...
  return (
    ...
    >
      {!isExpanded ? (
        /* Collapsed State: Single M3 Style 4 Standard Icon Button */
        <GeminiTooltip text="Allie Harvester & Settings" position={tooltipPosition}>
          <button
            type="button"
        ...
        /* Expanded State: M3 Elevated Stadium Pill Capsule */
        <div
        ...
        >
          {/* 1. Settings Button */}
          <GeminiTooltip text={settingsTooltip} position={tooltipPosition}>
            <button
              type="button"
          ...
          <GeminiTooltip text={exportSuccess ? 'Export Complete!' : 'Export Chat (ZIP Archive)'} position={tooltipPosition}>
            <button
              type="button"
          ...
          <GeminiTooltip text={syncSuccess ? 'Sync Complete!' : 'Sync & Re-scrape Chat to IndexedDB'} position={tooltipPosition}>
            <button
              type="button"
          ...
          <GeminiTooltip text="Collapse Toolbar" position={tooltipPosition}>
            <button
              type="button"
