  ...
  return (
    ...
    >
      {!isExpanded ? (
        ...
        <GeminiTooltip text="Allie Harvester & Settings" position="top">
          <button
            type="button"
        ...
        <div className="allie-toolbar-pill" role="toolbar" aria-label="Allie Scraper Actions">
          {/* 1. Settings Button */}
          <GeminiTooltip text={settingsTooltip} position="top">
            <button
              type="button"
          ...
          <GeminiTooltip text={exportSuccess ? 'Export Complete!' : 'Export Chat (ZIP Archive)'} position="top">
            <button
              type="button"
          ...
          <GeminiTooltip text={syncSuccess ? 'Sync Complete!' : 'Sync & Re-scrape Chat to IndexedDB'} position="top">
            <button
              type="button"
          ...
          <GeminiTooltip text="Collapse Toolbar" position="top">
            <button
              type="button"
