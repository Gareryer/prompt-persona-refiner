  ...
  return (
    ...
    >
      {!isExpanded ? (
        ...
        <ClaudeTooltip text="Allie Harvester & Settings" position={tooltipPosition}>
          <button
            type="button"
        ...
        >
          {/* 1. Settings Button */}
          <ClaudeTooltip text={settingsTooltip} position={tooltipPosition}>
            <button
              type="button"
          ...
          <ClaudeTooltip text={exportSuccess ? 'Export Complete!' : 'Export Chat (ZIP Archive)'} position={tooltipPosition}>
            <button
              type="button"
          ...
          <ClaudeTooltip text={syncSuccess ? 'Sync Complete!' : 'Sync & Re-scrape Chat to IndexedDB'} position={tooltipPosition}>
            <button
              type="button"
          ...
          <ClaudeTooltip text="Collapse Toolbar" position={tooltipPosition}>
            <button
              type="button"
