  ...
  describe('Background Logger with Secret Redaction', () => {
    it('sanitizes API keys and tokens from logs', () => {
      const payload = {
        ...
        geminiKey: 'AIzaSyD-123456789012345678901234567890',
        openAiKey: 'sk-1234567890123456789012345678901234',
        nested: {
          password: 'mypassword',
      ...
      expect(sanitized.geminiKey).toContain('AIza[REDACTED]');
      expect(sanitized.openAiKey).toContain('sk-[REDACTED]');
      expect(sanitized.nested.password).toBe('[REDACTED]');
      expect(sanitized.nested.encToken).toContain('enc:v1:[REDACTED]');
    });
...
console.log('Created tests/unit/orchestration.test.ts');
